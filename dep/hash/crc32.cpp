...
static const uint32_t crc32Lookup[8][256] = {
    ...
    //  crc32Lookup[0][crc32Lookup[0][i] & 0xFF]; crc32Lookup[2][i] =
    ...
    //  crc32Lookup[0][crc32Lookup[3][i] & 0xFF]; crc32Lookup[5][i] =
    //  (crc32Lookup[4][i] >> 8) ^ crc32Lookup[0][crc32Lookup[4][i] & 0xFF];
    //  crc32Lookup[6][i] = (crc32Lookup[5][i] >> 8) ^
    //  crc32Lookup[0][crc32Lookup[5][i] & 0xFF]; crc32Lookup[7][i] =
